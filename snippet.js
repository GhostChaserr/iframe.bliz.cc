...
(function() {
    ...
    function trackPageVisit() {
      var pageName = getPathname().replace(/\//g, '').substring(0, 100) || 'home';
      var event = createEvent('page_visit', pageName);
      processEvent(event);
    }
     ...
     */
    var API_ENDPOINT = 'https://api.bliz.cc/v1/events';
    ...
    function processEvent(event) {
      ...
      if (CONFIG.debug) {
        ...
        console.log('Bliz: API Payload', payload);
      }
